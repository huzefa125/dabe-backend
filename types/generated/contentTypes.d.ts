...
export interface ApiAboutAgencyAboutAgency extends Struct.SingleTypeSchema {
  collectionName: 'about_agencies';
  info: {
    displayName: 'About Agency';
    pluralName: 'about-agencies';
    singularName: 'about-agency';
  };
  options: {
...
export interface ApiFifaSectionFifaSection extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'FIFA Licensed band section';
    displayName: 'FIFA Section';
    pluralName: 'fifa-sections';
    singularName: 'fifa-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    buttonLink: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'/fifa-compliance'>;
    buttonText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Our compliance framework'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::fifa-section.fifa-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'A higher standard of representation.'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiGlobalReachGlobalReach extends Struct.SingleTypeSchema {
  collectionName: 'global_reaches';
  info: {
    description: 'Global reach section';
    displayName: 'Global Reach';
    pluralName: 'global-reaches';
    singularName: 'global-reach';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global-reach.global-reach'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Two hubs.\\nOne worldwide network.'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configurable hero section for the website';
  ...
  attributes: {
    ...
    description: Schema.Attribute.RichText &
      ...
      Schema.Attribute.DefaultTo<'Discover amazing features and experiences'>;
    enabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    heroImage: Schema.Attribute.Media<'images' | 'videos'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    minHeight: Schema.Attribute.String & Schema.Attribute.DefaultTo<'100vh'>;
    parallaxEnabled: Schema.Attribute.Boolean &
    ...
    subtitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Your journey starts here'>;
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Welcome to Our Site'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNavbarButtonNavbarButton extends Struct.SingleTypeSchema {
  collectionName: 'navbar_buttons';
  info: {
    displayName: 'Navbar Button';
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Office or map location';
    displayName: 'Office';
    pluralName: 'offices';
    singularName: 'office';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isHub: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::office.office'
    > &
      Schema.Attribute.Private;
    mapX: Schema.Attribute.String & Schema.Attribute.Required;
    mapY: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiPlayerPlayer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Player in the agency';
    displayName: 'Player';
    pluralName: 'players';
    singularName: 'player';
  };
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    publishedAtDate: Schema.Attribute.Date;
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global website configuration for footer and contact page';
  ...
  attributes: {
    addressNigeria: Schema.Attribute.Text;
    addressNorthAmerica: Schema.Attribute.Text;
...
export interface ApiStatStat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Global stats for the agency';
